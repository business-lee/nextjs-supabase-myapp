...
| F002    | 모임 생성          | ✅ Task 004, Task 008 | 🔄 UI 완료   |
| F003    | 모임 대시보드      | ✅ Task 004, Task 008 | 🔄 UI 완료   |
| F004    | 초대 링크 공유     | ✅ Task 005, Task 008 | 🔄 UI 완료   |
| F005    | 초대 링크 접속     | ✅ Task 006, Task 009 | 🔄 UI 완료   |
| F006    | 참가 신청 및 승인  | ✅ Task 006, Task 009 | 🔄 UI 완료   |
| F007    | 공지사항 CRUD      | ✅ Task 005, Task 010 | 🔄 UI 완료   |
| F008    | 카풀 매칭          | ✅ Task 005, Task 011 | 🔄 UI 완료   |
| F009    | 정산 관리          | ✅ Task 005, Task 012 | 🔄 UI 완료   |
| F010    | 모임 수정          | ✅ Task 004, Task 008 | 🔄 UI 완료   |
| F011    | 모임 취소          | ✅ Task 004, Task 008 | 🔄 UI 완료   |
| F012    | 대기자 자동 승급   | Task 009              | ⏳ 대기      |
| F013    | 참여 통계 표시     | ✅ Task 005, Task 009 | 🔄 UI 완료   |
| F014    | 카풀 활성화 토글   | ✅ Task 005, Task 011 | 🔄 UI 완료   |
| F015    | 정산 현황 공유     | Task 013              | ⏳ 대기      |
| F016    | 관리자 이벤트 관리 | Task 017              | ⏳ 대기      |
| F017    | 관리자 사용자 관리 | Task 018              | ⏳ 대기      |
| F018    | 관리자 통계 분석   | Task 019              | ⏳ 대기      |
| F019    | 프로필 관리        | ✅ Task 003, Task 008 | 🔄 일부 완료 |
...
│   └── /protected/meetings
│       ├── /protected/meetings         # 내 모임 목록 대시보드 (Task 004, 008)
